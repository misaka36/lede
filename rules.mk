...
TARGET_CFLAGS:=$(TARGET_OPTIMIZATION) $(call qstrip,$(CONFIG_EXTRA_OPTIMIZATION)) -Ofast -pipe
...
HOST_CFLAGS:=$(HOST_CPPFLAGS) -Ofast -pipe
HOST_CXXFLAGS:=$(HOST_CFLAGS) -Ofast -pipe
